...
namespace WebApiPractice
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddScoped(sp => ActivatorUtilities.CreateInstance<CarController>(sp));
            ...
            services.AddDbContext<CarDbContext>(x => x.UseSqlServer(Configuration.GetConnectionString("DefaultConnection1")));
